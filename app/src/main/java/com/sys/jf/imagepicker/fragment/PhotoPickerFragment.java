...
import com.sys.jf.imagepicker.adapter.PopupDirectoryListAdapter;
...
import com.sys.jf.imagepicker.utils.ImageCaptureManager;
import com.sys.jf.imagepicker.utils.MediaStoreHelper;
import com.sys.jf.imagepicker.utils.PermissionsConstant;
...
public class PhotoPickerFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        photoGridAdapter.setOnLimitListener(new PhotoGridAdapter.OnLimitListener() {
            @Override
            public void onLimit() {
                if (getActivity() instanceof PhotoPickerActivity && ((PhotoPickerActivity) getActivity()).getOnLimitSizeListener() != null) {
                    ((PhotoPickerActivity) getActivity()).getOnLimitSizeListener().onLimitSize();
                }
            }
        });
